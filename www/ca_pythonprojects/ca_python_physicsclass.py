...
# Write a function called f_to_c that takes an input f_temp, a temperature
...
# Define a variable c0_in_fahrenheit and set it equal to the value of c_to_f
# with 0 as an input.
...
# c is a constant that is usually set to the speed of light, which is roughly
# 3 x 10^8. Set c to have a default value of 3*10**8.
...
# Print the string "The GE train does X Joules of work over Y meters.", with X
# replaced with train_work and Y replaced with train_distance.
